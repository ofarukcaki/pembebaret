    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
      ...
      build: function(b) {
        ...
        (b = b ? b : this.factory.time.getDayCounter(this.showSeconds)),
          ...
          this.showSeconds
            ? a(this.createDivider("Saniye")).insertBefore(
                this.lists[this.lists.length - 2].$el
              )
            : (e = 2),
          a(this.createDivider("Dakika")).insertBefore(
            this.lists[this.lists.length - 4 + e].$el
          ),
          a(this.createDivider("Saat")).insertBefore(
            this.lists[this.lists.length - 6 + e].$el
          ),
          a(this.createDivider("Gün", !0)).insertBefore(this.lists[0].$el),
          this.base();
      },
      flip: function(a, b) {
